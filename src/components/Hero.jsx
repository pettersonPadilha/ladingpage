...
const Hero = () => (
  ...
  >
    ...
    >
      ...
      <h1
        className="
      flex1 font-roboto font-semibold ss:text-[68px]
      ...
      <p
        ...
        `}
      >
        Our team of experts uses a methodology to identify the credt cards mosts
    ...
    <div className={`
      ...
      <img src={robot} alt="alt billing" 
      // gradient
      className="w-[100%] h-[100%] relative z-[5]"/>
      <div class="absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient"></div>
      <div class="absolute z-[1] w-[80%] h-[80%] rounded-full bottom-40 pink__gradient white_gradient"></div>
      <div class="absolute z-[0] w-[50%] h-[50%] right-20 bottom-20 blue__gradient"></div>
    </div>
